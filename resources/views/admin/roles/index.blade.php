        ...
        <div class="w-full mb-4 overflow-hidden rounded-lg shadow-xs">
            <div class="w-full overflow-x-auto">
                <table class=" mt-8 text-center w-full whitespace-no-wrap">
                            ...
                            <tr class="text-gray-700 text-center dark:text-gray-400">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex align-middle items-center justify-center space-x-4 text-sm">
                                        <button data-role-id="{{ $role->id }}" data-role-name="{{ $role->name }}"
                                            class="edit-btn text-gray-500 transition-colors duration-200 dark:hover:text-yellow-500 dark:text-gray-300 hover:text-yellow-500 focus:outline-none">
                 ...
                 <!-- Modification modal -->
                @foreach ($roles as $role)
                <div id="modification-modal-{{ $role->id }}" aria-hidden="true"
                    ...
                    <div class="relative p-4 w-full max-w-md max-h-full">
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div
                                ...
                                <button type="button"
                                    class="close-btn end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                    data-modification-modal-hide="modification-modal">
                                    ...
                                    <span class="close-btn sr-only">Close modification-modal</span>
                                </button>
                            </div>
                            <!-- modification-modal body -->
                            <div class="p-4 md:p-5">
                                <form class="space-y-4"
                                    ...
                                    <button type="submit"
                                        class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">U
                                        P D A T E</button>
                    ...
                    <div class="relative p-4 w-full max-w-md max-h-full">
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div
                                ...
                                <button type="button"
                                    class="close end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
