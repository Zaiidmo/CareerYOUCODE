...
@section('content')
    <main id="main" class="h-full w-full">
        ...
        <div id="about_section" class="grid grid-cols-1 lg:grid-cols-3 gap-3">
            <div class="flex flex-col gap-4 px-16 lg:col-span-1 lg:pl-24 lg:pr-16 lg:pt-0">
                <div id="skills" class="">
                    <div id="skills" class="p-8  bg-white rounded-lg dark:bg-gray-800 shadow ">
                        <div class="mb-10 flex justify-between items-center">
                            <h1 class="font-semibold font-poppins tracking-widest text-gray-800 text-2xl dark:text-white">My Skills
                            </h1>
                            <button>
                ...
                <div id="contact" class="">
                    <div id="contact" class="p-8  bg-white rounded-lg dark:bg-gray-800 shadow ">
                        <div class="mb-10 flex justify-between items-center">
                            <h1 class="font-semibold font-poppins tracking-widest text-gray-800 text-2xl dark:text-white">Contact
                            </h1>
                        </div>
                        <div class="flex justify-center items-center gap-6 my-6">
                            <a class="text-gray-700 dark:text-gray-400 hover:text-blue-700 dark:hover:text-blue-700" aria-label="Visit TrendyMinds LinkedIn"
                                href="" target="_blank">
                            ...
                            <a class="text-gray-700 dark:text-gray-400 hover:text-blue-700 dark:hover:text-blue-700" aria-label="Visit TrendyMinds Facebook"
                                href="" target="_blank">
                            ...
                            <a class="text-gray-700 dark:text-gray-400 hover:text-blue-700 dark:hover:text-blue-700" aria-label="Visit TrendyMinds Instagram"
                                href="" target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="h-6">
                                    <path fill="currentColor"
                            ...
                            <a class="text-gray-700 dark:text-gray-400 hover:text-blue-700 dark:hover:text-blue-700" aria-label="Visit TrendyMinds Twitter"
                                href="" target="_blank">
            ...
            <div id="about" class="px-16 col-span-2 lg:pl-0 lg:pr-16 lg:pt-0 ">
                <div id="about" class="p-8 pb-0 bg-white rounded-lg dark:bg-gray-800 shadow ">
                    <h1 class="font-semibold font-poppins tracking-widest text-gray-800 text-2xl dark:text-white">About Me</h1>
                    <div class="col-span-2 px-16 lg:p-16 lg:pt-4 lg:pb-0 lg:pl-24 flex flex-col gap-3">
                        <div class="py-1 sm:py-5 flex flex-row justify-between sm:px-6 border-b dark:border-gray-400 border-black">
            ...
            <div id="applications" class="px-16 lg:col-span-3 lg:pl-24 mt-16 lg:pt-0">
                <div id="applications" class="p-8  bg-white rounded-lg dark:bg-gray-800 shadow ">
                    <div class="mb-10 flex justify-between items-center">
                        <h1 class="font-semibold font-poppins tracking-widest text-gray-800 text-2xl dark:text-white">My Applications
                        </h1>
                        <button>
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24"
                                class="text-gray-800 dark:text-white">
