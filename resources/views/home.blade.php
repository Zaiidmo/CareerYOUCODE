                    ...
                    <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2 lg:grid-cols-3 ">
                        ...
                        <div
                            ...
                            <div class="p-5 text-center">
                                ...
                                <div class="">
                                    <p
                                        class="line-clamp-1 p-3 rounded font-normal text-gray-700  dark:text-gray-400">
                                        {{$announcement->description}}
                                    </p>
                                </div>
                                <a href="{{ route('announcements.show', $announcement->id) }}">
                                    <button type="submit" 
                                        class="inline-flex self-end items-center px-3 py-2 text-sm font-medium text-center dark:text-white text-black rounded-lg hover:bg-blue-800 dark:hover:bg-blue-700 hover:text-white">
                                        Read more
                                ...
                                <div class="flex flex-wrap justify-center border-t dark:border-gray-500 border-gray-400 mt-4 w-full h-fit">
                                    @foreach ($announcement->skills as $skill) 
                                        <span class="bg-gray-100 mt-3 text-gray-800 text-xs font-medium me-2 px-2 py-2 rounded-full dark:bg-gray-700 dark:text-white border border-gray-500">{{ $skill->name}}</span>
                                    @endforeach 
                                </div>
                            </div>
                        </div>
